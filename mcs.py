...
connections1 = [('1', '2'), ('1', '3'),('2','3'), ('3', '4'),('3', '7'),('4','5'),('5','6'),
                ('4', '6'),  ('4', '8'),('7','8'),('7','9'),('8','9')]

connections=[('1','2'),('1','3'),('1','5'),('1','4'),('3','2'),('3','1'),('3','5'),('5','4'),('2','5')]


connections2=[('1', '3'), ('1', '4'),('1','6'), ('2', '3'),('2', '7'),('3','8'),('3','6'),
              ('3', '4'),('4', '5'),('4','9'),('4','6'),('5','10'),('7','8'),('8','11'),('11','9'),
              ('9','10')]
...
def is_connected(g, n1, n2):                     # check if n1 is adjacent to n2
    return n1 in g.nodes() and n2 in g.nodes(n1)

def get_connections(g,nodes):
...
def mcs(g:nx):
    ...
    for i in range(nodes,0,-1):
        ...
        order[i - 1] = v
        g1.remove_node(v)
    fillin_graph = nx.Graph(fill_edges)
    return order, fillin_graph, clique_gen
    ...
    for x in order:
        if x in clique_gen:
            ...
            if is_clique(g, separator) == True:
                ...
                leaf_graph = nx.Graph(conn)  ## form leaf graph which does not admit clique-cutset.
